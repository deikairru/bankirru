...
const TransferSkeleton = () => {
  return (
    <section className="payment-transfer">
      ...
      <section className="size-full pt-5 animate-pulse">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-row gap-8 w-full max-w-[850px] mt-2 py-4 border-t-2 border-slate-100 ">
              <div className="flex flex-col gap-2 w-1/3">
                <div className="w-full h-3 mb-2 bg-slate-300 rounded-md"></div>
                <div className="w-full h-2 bg-slate-300 rounded-md"></div>
                <div className="w-full h-2 bg-slate-300 rounded-md"></div>
              </div>
              <div className="w-2/3 h-30 bg-slate-50 border-slate-300 border-2 rounded-md"></div>
            </div>
            <div className="flex flex-row gap-8 w-full max-w-[850px] mt-2 py-4 border-t-2 border-slate-100 ">
              <div className="flex flex-col gap-2 w-1/3">
                <div className="w-full h-3 mb-2 bg-slate-300 rounded-md"></div>
